...
export const Heart: React.FC<React.SVGProps<SVGSVGElement> & { isFilled?: boolean }> = ({ isFilled, ...props }) => (
  <svg
...
export const Padlock: React.FC<React.SVGProps<SVGSVGElement> & { isUnlocked: boolean }> = ({ isUnlocked, className, ...props }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width="24"
    height="24"
  ...
  >
    ...
    <path
      d={isUnlocked ? "M7 11V7a5 5 0 0 1 9.9-1" : "M7 11V7a5 5 0 0 1 10 0v4"}
...
export const Music: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
